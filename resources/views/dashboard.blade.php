                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-baseline">
                                    <h6 class="card-title mb-0">Total Donars</h6>
                    ...
                    <div class="col-md-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-12 col-xl-5">
                                        <h3 class="mb-2">{{ $total_donations }}</h3>
                                        <div class="d-flex align-items-baseline">
                                            <p class="text-danger">
                                                {{-- <span>-2.8%</span> --}}
                                                {{-- <i data-feather="arrow-down" class="icon-sm mb-1"></i> --}}
                    ...
                    <div class="col-md-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-12 col-xl-5">
                                        <h3 class="mb-2">{{ $total_transactions }}</h3>
                    ...
                    <div class="col-md-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-12 col-xl-5">
                                        {{-- <h3 class="mb-2">{{ count(auth()->user()->donations()->all()) }}</h3> --}}
                                        {{-- <div class="d-flex align-items-baseline">
